...
export const routeOptions: RouteOption[] = [
  {
    ...
    reservationNodes: ["reservationNodes.audioGuide", "reservationNodes.shuttle"],
  ...
  },
  {
    ...
    waypoints: [
      "waypoints.visitorCenter",
      "waypoints.lycheeGarden",
      "waypoints.foodClassroom",
      "waypoints.treeAdoption",
    ],
    reservationNodes: ["reservationNodes.foodClass", "reservationNodes.treeAdoption"],
  ...
  },
  {
    ...
    waypoints: [
      "waypoints.visitorCenter",
      "waypoints.shadedAncientRoad",
      "waypoints.ridgeCourtyard",
      "waypoints.waterfrontRest",
    ],
    reservationNodes: ["reservationNodes.coolRest", "reservationNodes.shuttle"],
  ...
  },
  {
    ...
    waypoints: [
      "waypoints.visitorCenter",
      "waypoints.ancientRoad",
      "waypoints.villageMeal",
      "waypoints.ridgeCourtyard",
      "waypoints.morningFarm",
      "waypoints.resilienceWorkshop",
    ],
    reservationNodes: ["reservationNodes.courtyardStay", "reservationNodes.villageMeal"],
