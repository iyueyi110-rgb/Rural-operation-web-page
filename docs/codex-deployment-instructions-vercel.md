...
ADMIN_LOGIN_PASSWORD="<独立的管理员登录口令>"
ADMIN_SESSION_SECRET="<独立的随机生成 64 位 hex>"
...
| `ADMIN_API_TOKEN`                 | web + admin server | ⚠️         |
| `WEB_API_BASE`                    | admin server       | 否         |
| `ADMIN_LOGIN_PASSWORD`            | admin server       | ⚠️         |
| `ADMIN_SESSION_SECRET`            | admin server       | ⚠️         |
